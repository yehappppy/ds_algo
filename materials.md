<h1 style="text-align: center;">Please check or clone this project <a href="https://github.com/jwasham/coding-interview-university.git">coding-interview-university</a></h1>
...
- ### Binary search trees: BSTs
    ...
    - [x] Implement:
        ...
        - [x] get_min   // returns the minimum value stored in the tree (use both iteractive and recursive)
        - [x] get_max   // returns the maximum value stored in the tree (use both iteractive and recursive)
